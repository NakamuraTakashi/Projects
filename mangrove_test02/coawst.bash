...
#export   COAWST_APPLICATION=MANGROVE_RH
export   COAWST_APPLICATION=MANGROVE_BG
#export   COAWST_APPLICATION=NO_MANGROVE
...
export   MY_ROOT_DIR=${HOME}/COAWST/COAWST_Eco
