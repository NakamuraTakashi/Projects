...
#define SSH_TIDES  /* deactivate when the case of HYCOM ESPC_D_V02 boundary */
#define UV_TIDES   /* deactivate when the case of HYCOM ESPC_D_V02 boundary */
#define ADD_FSOBC  /* deactivate when the case of HYCOM ESPC_D_V02 boundary */
#define ADD_M2OBC  /* deactivate when the case of HYCOM ESPC_D_V02 boundary */
